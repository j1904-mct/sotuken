...
void accumulate_force_from_point(myvector dx, real r2, real eps2, 
				 myvector & acc,
				 real & phi,
				 real jmass)
{
...
void bhnode::accumulate_force_from_tree(myvector & ipos, real eps2, real theta2,
					myvector & acc,
					real & phi)
{
